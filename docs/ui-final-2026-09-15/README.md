...
관련 요구사항: 최종 Figma A16-안, 9월 15일 사용자 화면 QA 및 이후 근력운동·센서 미션 피드백. 현재 [제품 요구사항](../기획/요구사항정의서.md)의 FR-100~118과 관련 공통 요구에 대응합니다.
...
누적 변경은 Android 소스 **168개 경로(추가 101·수정 66·삭제 1)**와 제품 문서·설명·화면 이미지 10개 파일입니다. Git의 이름 변경 감지에서는 접근성 보조 클래스의 테스트 폴더 이동이 하나로 묶여 Android 167개 파일로 보입니다. UI 폴더뿐 아니라 리소스와 Android 클라이언트 연결 코드도 함께 검토해야 합니다.

## 현재 제품 문서

[문서 안내](../기획/README.md), [PRD](../기획/PRD.md), [요구사항 정의서](../기획/요구사항정의서.md), [유저 플로우](../기획/유저플로우.md), [개정 대조·후속 확인](../기획/개정대조.md)을 추가했습니다. 예전 문서의 112개 요구사항 ID를 유지하고 현재 기능을 포함한 134개 항목을 코드·부분·후속·대체·제거로 구분했습니다.

현재 5개 메뉴, A16 일수 저장, 틈새 운동·보상, 최근 7일과 쉼의 기간 차이, peer 점수와 허리둘레 재계산, 동의·CSV·소리를 현행 코드에 맞췄습니다. SHAP/XAI 검토 자료와 운영 미검증 사항은 별도로 명시했습니다. 이 문서 개정은 앱·서버 코드를 바꾸지 않습니다.
...
이 PR의 Android 소스는 위 트리와 동일하며 제품 문서·설명·화면 파일만 추가했습니다.
